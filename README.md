...
[![Check formatting, lint rules, and types](https://github.com/misclabs/rayjs/actions/workflows/check.yml/badge.svg)](https://github.com/misclabs/rayjs/actions/workflows/check.yml)
